...
5. Update `checklist.md` as items are completed
...
- [ ] `spec.md` Completion Notes section filled in
...
Declare the feature complete or identify what remains. If complete, the feature is ready to commit/merge.
