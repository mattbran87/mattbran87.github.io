...
Read the feature spec at `specs/012-analytics/spec.md` and all supporting documents in that directory. Also read `docs/lessons-learned.md` for known pitfalls and patterns relevant to this feature.
