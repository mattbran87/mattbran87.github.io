...
Read the feature spec at `specs/020-social-sharing/spec.md` and all supporting documents in that directory. Also read `docs/lessons-learned.md` for known pitfalls and patterns relevant to this feature.
