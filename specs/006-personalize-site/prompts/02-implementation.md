...
Read the feature spec at `specs/006-personalize-site/spec.md` and all supporting documents in that directory — especially `tasks.md` and `decisions.md`.

## Objectives

1. Create a feature branch (e.g., `feature/006-personalize-site`)
