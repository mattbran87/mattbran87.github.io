...
Read the feature spec at `specs/011-code-blocks/spec.md` and all supporting documents in that directory. Also read `docs/lessons-learned.md` for known pitfalls and patterns relevant to this feature.
