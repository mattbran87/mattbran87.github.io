...
Read the feature spec at `specs/025-table-of-contents/spec.md` and all supporting documents in that directory — especially `tasks.md` and `decisions.md`.

## Objectives

1. Create a feature branch (e.g., `feature/025-table-of-contents`)
