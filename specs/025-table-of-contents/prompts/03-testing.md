...
Read the feature spec at `specs/025-table-of-contents/spec.md` and all supporting documents in that directory. Also read `docs/lessons-learned.md` for known pitfalls to check during testing.
